    ...
    <div class="container">
      ...
      <div class="jumbotron">
		...
		<form action="" method="post">
			...
			<?php
				$po = viewPurchaseOrder($quote_id,$conn);
				$discount = floatval($po['Discount']);
				$discount_type = $po['Discount_Type'];
				if ($discount_type == 0) $discount_type="Amount"; 
				else $discount_type="Percent";
			?>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-xs-10">
					<input type="text" class="form-control" value="<?php echo $discount_type;?>" readonly>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-xs-10">
					<p id="total">$ <?php echo $po['Total'];?></p>
